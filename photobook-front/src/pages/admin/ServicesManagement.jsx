...
/* eslint-disable react-hooks/exhaustive-deps */
  ...
  const getCategoryInfo = (categoryValue) => {
    return categories.find(c => c.value === categoryValue) || { label: categoryValue, icon: '📸', color: 'from-gray-500 to-gray-600' };
  };
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {services.map((service) => {
          ...
          return (
            <div
              key={service.id}
              className={`bg-white dark:bg-gray-800 rounded-2xl shadow-sm hover:shadow-md transition-all overflow-hidden ${
                ...
                <div className="space-y-3 mb-6">
                  ...
                  {service.maxParticipants && (
                    <div className="flex items-center gap-2 text-sm">
                      ...
                      <span className="text-gray-700 dark:text-gray-300">
                        Max {service.maxParticipants} participant(s)
                      </span>
                    </div>
                  )}
                </div>
      ...
      {services.length === 0 && !showForm && (
        <div className="bg-white dark:bg-gray-800 rounded-2xl p-12 text-center">
          ...
          <p className="text-gray-500 dark:text-gray-400 mb-6">
            Commencez par créer votre premier service photographique
          </p>
          <button
