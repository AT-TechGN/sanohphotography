          ...
          <div className="lg:col-span-1">
            <Link to="/" className="flex items-center gap-2 mb-4">
              ...
              <span className="text-xl font-bold">
                Sanoh<span className="text-purple-400">Photo</span>
              </span>
            </Link>
          ...
          <div>
            ...
            <form onSubmit={(e) => e.preventDefault()} className="flex gap-2">
              <input 
                ...
                className="flex-1 px-3 py-2 rounded-lg bg-gray-800 text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-purple-500 text-sm border border-gray-700"
              />
              <button className="px-4 py-2 bg-gradient-to-r from-purple-600 to-pink-600 rounded-lg text-white font-medium hover:from-purple-700 hover:to-pink-700 transition-all text-sm">
                OK
              </button>
            </form>
          </div>
